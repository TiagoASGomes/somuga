...
public class Messages {
    ...
    public static final String INVALID_DEVELOPER_NAME = "Developer name cannot be empty";
    public static final String INVALID_PLATFORM_NAME = "Platform name cannot be empty";
    public static final String INVALID_GENRE_NAME = "Genre name cannot be empty";
