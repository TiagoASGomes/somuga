...
public class Messages {
    ...
    public static final String INVALID_DEVELOPER_NAME = "Developer name must be between 1 and 50 characters, and can only contain letters, numbers and spaces";
    public static final String INVALID_PLATFORM_NAME = "Platform name must be between 1 and 50 characters, and can only contain letters, numbers and spaces";
    public static final String INVALID_GENRE_NAME = "Genre name must be between 1 and 50 characters, and can only contain letters, numbers and spaces";
